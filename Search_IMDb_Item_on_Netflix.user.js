...
if ( self === top && document.title.match( /\(Video Game [0-9]{4}\) - IMDb$/ ) === null ) {
	...
	var itemTitle            = document.getElementById( 'overview-top' ).getElementsByClassName( 'header' )[0].firstElementChild.textContent.trim(),
		titleOverview        = document.getElementsByClassName( 'title-overview' )[0],
	...
	titleOverview.parentNode.insertBefore( searchNetflixContain, titleOverview.nextSibling );
}
